...
bool AclConvExecutor::init(const ConvAttrs& convAttrs,
    ...
    unsigned int pad_l = convAttrs.paddingL.at(1);
    unsigned int pad_r = convAttrs.paddingR.at(1);
    unsigned int pad_t = convAttrs.paddingL.at(0);
    unsigned int pad_b = convAttrs.paddingR.at(0);
    unsigned int stride_x = convAttrs.stride.at(1);
    ...
    arm_compute::Size2D dilation(convAttrs.dilation.at(1), convAttrs.dilation.at(0));
